...
APU_BASE	= $0110
APU_PL1_VOL	= APU_BASE
APU_PL1_SWEEP	= APU_BASE+1
APU_PL1_LO	= APU_BASE+2
APU_PL1_HI	= APU_BASE+3
APU_PL2_VOL	= APU_BASE+4
APU_PL2_SWEEP	= APU_BASE+5
APU_PL2_LO	= APU_BASE+6
APU_PL2_HI	= APU_BASE+7
APU_TRI_LINEAR	= APU_BASE+8
APU_TRI_LO	= APU_BASE+$a
APU_TRI_HI	= APU_BASE+$b
APU_NOISE_VOL	= APU_BASE+$c
APU_NOISE_LO	= APU_BASE+$e
APU_NOISE_HI	= APU_BASE+$f
APU_DMC_FREQ	= APU_BASE+$10
APU_DMC_RAW	= APU_BASE+$11
APU_DMC_START	= APU_BASE+$12
APU_DMC_LEN	= APU_BASE+$13
APU_SND_CHN	= APU_BASE+$15
